...
const RoomCard = ({room, bookRoom}) => {
    return <div className="roomcard">
        ...
        <h3> {room.name} </h3>
        {/* <p> Rating: {room.rating} <StarRateIcon style={{margin: 'auto'}} /> <StarRateIcon style={{margin: 'auto'}} /> <StarRateIcon style={{margin: 'auto'}} /> <StarRateIcon style={{margin: 'auto'}} /> <StarRateIcon style={{margin: 'auto'}} /> </p> */}
